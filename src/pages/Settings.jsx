...
export default function Settings() {
    const { clearAllData, aiConfig, setAiConfig } = useApp();
    const [dbConfig, setDbConfig] = useState(() => {
        const stored = localStorage.getItem("inertia_db_config");
    ...
    const handleSave = () => {
        ...
        localStorage.setItem("inertia_db_config", JSON.stringify(dbConfig));
        ...
        <div className="max-w-xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-6">
                ...
                <section className="space-y-4">
                    <h2 className="text-xl font-semibold text-zinc-800 dark:text-zinc-200">Database Connection</h2>
                    <div className="p-5 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 space-y-4">
                        <div className="space-y-1">
                            <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100">Connect your Supabase instance to enable sync and auth.</p>
                            <p className="text-xs text-zinc-500">Get these from your Supabase Project Settings -&gt; API.</p>
                        </div>
                        <div className="space-y-3">
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 mb-1.5">Supabase URL</label>
                                <input
                                    value={dbConfig.url}
                            ...
                            <div>
                                <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 mb-1.5">Supabase Anon Key</label>
                                <input
                                    type="password"
                                    value={dbConfig.key}
